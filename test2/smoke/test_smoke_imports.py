...
MODULOS_CORE = [
    ...
    # Scripts de entrada adicionales (además de main.py/inputs.py, que son
    # Windows-only por pywin32 y se testean aparte más abajo). No tenían
    # cobertura de import: `update_script.py` sólo usa stdlib+requests,
    # `run_jurisdicciones_from_db.py` sólo usa stdlib+asyncio+los mismos
    # paquetes de la app que ya se importan en este archivo, así que no
    # deberían fallar por plataforma.
    "update_script",
    "run_jurisdicciones_from_db",
]
