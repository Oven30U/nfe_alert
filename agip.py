    ...
    async def consultar_notificaciones(self):
        try:
            ...
            # else:
                ...
                await self.page.wait_for_selector(f"xpath=//li[@id='opRepresentados']//a[@class='dropdown-toggle']", timeout=900000)
                ...
                await self.page.wait_for_selector("xpath=//button[@class='btnNoLeidas btn btn-default']", timeout=900000)
