...
SELECT TOP 1 [pass], [fecha_actualizacion_pass] FROM clientes WHERE nombre = 'FACEBOOK ARGENTINA S.R.L' ORDER BY id DESC
...
'cThcP506Y8lr'
datetime.datetime(2024, 9, 16, 17, 55, 11, 754580)
...
INSERT INTO clientes_temp (nombre, pass, fecha_actualizacion_pass, id_username)
SELECT nombre, pass, fecha_actualizacion_pass, id_username FROM clientes;
...
select * from clientes where nombre = 'FACEBOOK ARGENTINA S.R.L'